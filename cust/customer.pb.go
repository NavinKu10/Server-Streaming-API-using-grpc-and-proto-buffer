...
var file_customer_proto_rawDesc = []byte{
	...
	0x12, 0x04, 0x63, 0x75, 0x73, 0x74, 0x22, 0x17, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x75, 0x6c, 0x74, 0x32, 0x40, 0x0a, 0x0f, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x79, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2d, 0x0a, 0x08, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x70,
	0x6c, 0x79, 0x12, 0x0d, 0x2e, 0x63, 0x75, 0x73, 0x74, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x0e, 0x2e, 0x63, 0x75, 0x73, 0x74, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
...
var file_customer_proto_goTypes = []interface{}{
	(*Request)(nil),  // 0: cust.Request
	(*Response)(nil), // 1: cust.Response
}
var file_customer_proto_depIdxs = []int32{
	0, // 0: cust.MultiplyService.Multiply:input_type -> cust.Request
	1, // 1: cust.MultiplyService.Multiply:output_type -> cust.Response
...
type MultiplyServiceClient interface {
	Multiply(ctx context.Context, in *Request, opts ...grpc.CallOption) (MultiplyService_MultiplyClient, error)
}
...
func (c *multiplyServiceClient) Multiply(ctx context.Context, in *Request, opts ...grpc.CallOption) (MultiplyService_MultiplyClient, error) {
	stream, err := c.cc.NewStream(ctx, &_MultiplyService_serviceDesc.Streams[0], "/cust.MultiplyService/Multiply", opts...)
	if err != nil {
		return nil, err
	}
	x := &multiplyServiceMultiplyClient{stream}
...
type MultiplyService_MultiplyClient interface {
	Recv() (*Response, error)
	grpc.ClientStream
}

type multiplyServiceMultiplyClient struct {
	grpc.ClientStream
}

func (x *multiplyServiceMultiplyClient) Recv() (*Response, error) {
	m := new(Response)
...
type MultiplyServiceServer interface {
	Multiply(*Request, MultiplyService_MultiplyServer) error
}
...
func (*UnimplementedMultiplyServiceServer) Multiply(*Request, MultiplyService_MultiplyServer) error {
...
func _MultiplyService_Multiply_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(Request)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(MultiplyServiceServer).Multiply(m, &multiplyServiceMultiplyServer{stream})
}

type MultiplyService_MultiplyServer interface {
	Send(*Response) error
	grpc.ServerStream
}

type multiplyServiceMultiplyServer struct {
	grpc.ServerStream
}

func (x *multiplyServiceMultiplyServer) Send(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

var _MultiplyService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cust.MultiplyService",
